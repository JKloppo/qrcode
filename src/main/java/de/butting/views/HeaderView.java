...
//	private FontAwesomeIconView homeBtnIcon = new FontAwesomeIconView(FontAwesomeIcon.CUBES);
	private Label headlineLabel = new Label("BUTTING QR-Generator");
	private Image image = new Image("file:src/main/resources/Butting-Logo_mit_Schrift.png", 325, 70, false, false);
	private ImageView imgView = new ImageView(image);
