...
public class MainView extends BorderPane {
	...
	private DefaultButton generateBtn = new DefaultButton("Generieren");
	private DefaultButton saveAsImageBtn = new DefaultButton("Als Bild speichern");
	private DefaultLabel inputUrlHereLabel = new DefaultLabel("URL hier einfügen:");
	private DefaultTextField urlTextField = new DefaultTextField("URL eingeben");
